...
# write.csv(nobo2, "./Scaledto_StudySite_CleanedTelem.csv")# this file has real vs random points generated for the MCP Scale 
...
# write.csv(nobo1, "./ResSelData_Property.csv") # this file has real vs random points generated for the MCP Scale 
